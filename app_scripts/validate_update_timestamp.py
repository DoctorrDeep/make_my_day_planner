...
def validate_update_timestamp(
    ...
    for timeset in list_of_timesets:
        ...
        if datetime.fromisoformat(timeset[1]) > datetime.fromisoformat(temp_timeset[0]) >= datetime.fromisoformat(
                timeset[0]):
        ...
        if datetime.fromisoformat(timeset[1]) >= datetime.fromisoformat(temp_timeset[1]) > datetime.fromisoformat(
                timeset[0]):
